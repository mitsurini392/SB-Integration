(function ($) {
    $datatype = { Table: 1, Json: 2, Xml: 3, JqGrid: 4 }; var $defaults = { containerid: "tblExport", datatype: $datatype.Table, dataset: null, columns: null, returnUri: false, worksheetName: "Report Form", encoding: "utf-8" }; var $settings = $defaults; $.fn.btechco_excelexport = function (options) {
