...
<div class="col-md-2 col-sm-3" id="logodiv">		
	<img style="margin-left: 10px" src="<?php echo $_user_companylogo; ?>"  id="logo" onClick="javascript:window.location='index.php?ui=<?php echo $ui; ?>&ci=<?php echo $ci; ?>'" alt="<?php echo $_company_business_name; ?>" id="idimglogo" />
</div>
...
<div class="col-md-3 col-xs-12" style="padding:0;">	
	<div class="col-md-12 col-xs-12" id="searchform">
		...
		<div class="col-md-2 col-xs-1 navbar-form navbar pull-right" style="padding:0">
		...
		<div class="col-md-9 col-xs-10" style="padding-right: 0">
			<div class="input-group add-on pull-right" style="margin-top: 10px;">
				<input class="form-control autofillSearch" style="width:100%" placeholder="Search Forms..." name="search" id="srch-term" type="text"/>
