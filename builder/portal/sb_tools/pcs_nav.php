...
<?php
    ...
    $breadcrumb = '<div class="col-sm-12" style="border: solid 1px #e7e7e7; background-color: rgb(250,250,250); padding-bottom: 0.5%; display:'.$navName.'" id="navName">
        <div>
            ...
            <div class="col-md-3" style="padding-top: 1%; padding-right: 5%;"> 
                <a href="dashboard_projects.php?ui='.$ui.'&ci='.$ci.'&pid='.base64_encode($pid).'"><button class="btn btn-block btn-primary" onclick="goProject()"> RETURN TO PROJECT PAGE </button></a>
            </div>
        </div>
    </div>
    <br> <br>';
    $singlenav .= $breadcrumb;
 ?>
