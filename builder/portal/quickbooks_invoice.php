...
<form method="POST">
	...
	<div id="c-container" style="display:none">
		...
		<section>
			...
			<table id="tbl_records_invoice" class="table table-striped table-bordered" cellspacing="0" width="100%">
				<thead>
				<tr>
					...
					<!--<td class='text-center' nowrap>Item</td>-->
            ...
            <section class="row">
                <input type="submit" name="sbpush_invoice" id="sbpush_invoice" class="center-block btn btn-lg btn-success" value="Move to Quickbooks">
			</section>
