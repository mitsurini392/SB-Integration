...
$form_id = "";
$pagename = "Quickbooks - Expense Claims";
...
<form method="POST">
	...
	<div id="c-container" style="display:none">
		...
		<section>
			...
			<table id="tbl_records_expense" class="table table-striped table-bordered" cellspacing="0" width="100%">
				<thead>
					<tr>
						<td class='text-center' style="color:#FFF; width:40px;" nowrap>&nbsp;<input type="checkbox" name="chkAll" id="chkAll">&nbsp;</td>
						<td class='text-center' nowrap>Account Type</td>
						<td class='text-center' nowrap>Project Name</td>
						<td class='text-center' nowrap>Supplier/Subcontractor</td>
						<td class='text-center' nowrap>Due Date</td>
						<td class='text-center' nowrap>Date Paid</td>
						<td class='text-center' nowrap>Amount (Inc. of GST)</td>
					</tr>
				</thead>
            ...
            <section class="row">
                <input type="submit" name="sbpush_expense" id="sbpush_expense" class="center-block btn btn-lg btn-success" value="Move to Quickbooks">
			</section>
