...
$form_id = "";
$pagename = "Quickbooks - Timesheets";
...
<form method="POST">
	...
	<div id="c-container" style="display:none">
		...
		<section>
			...
			<section class="row">
                <input type="submit" name="sbpush_timesheet" id="sbpush_timesheet" class="center-block btn btn-lg btn-success" value="Move to Quickbooks">
			</section>
