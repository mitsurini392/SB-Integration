...
<form method="POST">
	...
	<div id="c-container" style="display:none">
		...
		<section>
			...
			<table id="tbl_records_employees" class="table table-striped table-bordered" cellspacing="0" width="100%">
				<thead>
					<tr>
            ...
            <section class="row">
                <input type="submit" name="sbpush_employee" id="sbpush_employee" class="center-block btn btn-lg btn-success" value="Move to Quickbooks">
			</section>
...
$('#tbl_records_employees').dataTable( {
